                    ...
                    <div class="department col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ul dir="rtl" class="breadcrumb">
                                <?php $terms = get_terms( array('taxonomy' => 'fatwa_cat','hide_empty' => false,) ); ?>
                                        <?php foreach ($terms as $term) { ?>
                                <li class="breadcrumb-item">
                                    <i class="fa fa-folder-open" aria-hidden="true"></i>
                                    <a href="<?= SH_BlogUrl.'/fatwa-category/'.$term->slug; ?>"><?= $term->name; ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </nav>
                      ...
                      <div class="department_one col-md-12">     
                        ...
                        <div class="pagin">
                            <nav aria-label="Page navigation fatwa">
                                <?php    
                                    $args = array(
                                       'format'             => '?paged=%#%',
