            ...
            <div class="page">
                <div class="container">
                    ...
                    <ul class="bread_crumb list-unstyled">
                        ...
                        <li>
                         <a title="الرئيسية" href="<?php bloginfo('url'); ?>/مكتبة-الصوتيات">
                                مكتبة الصوتيات
                            </a>
                         </li>
                         <li>
                                    ...
                                    <ul class="videopost_details">
										<li class="category">
                                            ...
                                            <?php $post_terms = get_the_terms(get_the_ID(),'category');?>
                                                 ...
                                                 <a href="<?= SH_BlogUrl.'/category/'.$post_term->slug; ?>" ><?= $post_term->name; ?>	
                                                 </a>
                                                <?php } ?>
                                         </li>
										<li class="date">
                                                    ...
                                                    <li class="fawaedpost">
                                                        ...
                                                        <ul class="fawaedpost_details">
                                                            <li class="category">
                                                                ...
                                                                <a href="<?= SH_BlogUrl.'/category/'.$ha_category->slug; ?>" ><?php echo $ha_category->name. ' '; ?></a>
                                                                <?php }?>
                                                            </li>
                                                        </ul>
                                                    </li>
